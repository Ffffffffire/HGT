...
def run_model_DBLP(args):
    ...
    for i in range(args.repeat):
        ...
        net = AGT(num_classes, in_dims, args.hidden_dim, args.ffn_dim, args.num_layers, args.num_heads, args.dropout, args.num_g)
        ...
        for epoch in range(args.epoch):
            ...
            logits = net(features_list, train_seq, norm=True)
            ...
            with torch.no_grad():
                ...
                logits = net(features_list, val_seq, norm=True)
                logp = F.log_softmax(logits, 1)
        ...
        net.eval()
        with torch.no_grad():
            logits = net(features_list, test_seq, norm=True)
            test_logits = logits
