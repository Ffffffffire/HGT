...
from GT import GT, RGT, RGT_v2, RGT_v3, RGT_v4
...
def run_model_DBLP(args):
    ...
    for i in range(args.repeat):
        ...
        net = RGT_v4(num_classes, in_dims, args.hidden_dim, args.ffn_dim, args.num_layers, args.num_heads, args.dropout, args.rl_dim)
        net.to(device)
